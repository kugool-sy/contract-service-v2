...
async function airDrip(airDropObj){
    ...
    for( ; leftToDrop>0; ){
        ...
        const activityId = "0x5407f01eb9a34efea0ea17f7cc3d836bf0af1c0ab2c5762d8dc2fb309fe2fdf5"
        try{
        ...
        //     console.log(`on board success`)
        // }catch(e){
        //     console.log(`remoteMinerOnBoard error: `,e)
        //     throw e
        // }
        ...
        try{
            ...
            const success = await activeRemoteMiner(authorization.owner, authorization.address)
            if(success){
                ...
                console.log(`owner: ${authorization.owner}`)
                console.log(`miner: ${authorization.address}`)
