...
import { GetStartNumber, UpdateStartNumber } from "./StartNumberModel";

var CronJob = require( 'cron').CronJob;

const provider = new InfuraProvider("matic","68a2de3671204e8c91871ee8d0c927f3")
const contractAddress = "0xbf8eF5D950F78eF8edBB8674a48cDACa675831Ae"
...
export async function activeMiner(){
    ...
    for(tokenId = startNum; tokenId <= upperLimit; tokenId++){
        ...
        logger.info(`------> find owner of target tokenId form chain`)
        try{
        ...
        for(count=3; count > 0; count--){
            ...
            try{
                ...
                if((res.result && res.result === 200)  || (res.error && res.error.code === 20171) ){
