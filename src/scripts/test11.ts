import {getAddress, InfuraProvider, Interface} from 'ethers'

// console.log(getAddress("0xc4f795514586275c799729af5ae7113bdb7ccc86"))
...
(async function(){
    ...
    console.log(block)
    // const response = await provider.getTransaction("0x27657c14095051bbf52a244e5b575eccc1d04ae96239fcfa3cde21ebfcde949e")
